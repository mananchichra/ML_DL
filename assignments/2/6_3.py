...
gmm_custom = GMM(n_components=100, n_iterations=100, reg_covar=1e-6)  # Include n_iterations and reg_covar if needed
...
gmm_sklearn = GaussianMixture(n_components=100, random_state=42)
...
plt.title('Clusters by Custom GMM')
plt.xlabel('PC 1')
plt.ylabel('PC 2')
...
plt.title('Clusters by Sklearn GMM')
plt.xlabel('PC 1')
plt.ylabel('PC 2')
